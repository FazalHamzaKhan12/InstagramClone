          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(
                      10), // Correct usage of borderRadius
                ),
                child: Center(
                  child: Text(
                    'Edit Profile',
            ...
            Row(
              children: [
                ...
                Container(
                  width:
                      80, // Diameter of the CircleAvatar (2 * radius + border width)
                  height: 80,
                  decoration: BoxDecoration(
                  ...
                  tabs: [
                    Tab(
                      icon: UiHelper.customImages(
                          imgurl:
                              "Grid Icon.png"), // Correct usage of the `icon` parameter
                    ),
                    Tab(
                      icon: UiHelper.customImages(
                          imgurl: "Tags Icon.png"), // Also use `icon` here
                    ),
                  ],
                ),
              ),
